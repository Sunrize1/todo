...
function refresh() {
    ...
    for (let task of undoneTasks)undoneTasksPlace.innerHTML += `<div class="task d-flex text-body-secondary pt-3">
            ...
            <div class="pb-3 mb-0 small lh-sm border-bottom w-100">
              <div class="d-flex justify-content-between">
                ...
                <div>
                  <a class="edit" href="#">\u{420}\u{435}\u{434}\u{430}\u{43A}\u{442}\u{438}\u{440}\u{43E}\u{432}\u{430}\u{442}\u{44C}</a>
                  <a class="delete" href="#">\u{423}\u{434}\u{430}\u{43B}\u{438}\u{442}\u{44C}</a>
                </div>
              </div>
            </div>
          </div>`;
    for (let task of doneTasks)doneTasksPlace.innerHTML += `<div class="task d-flex text-body-secondary pt-3">
...
async function createTask() {
    ...
    if (inputTask.value.trim() !== "") {
        try {
            const response = await (0, _axiosDefault.default).post(URL_ + "tasks" + "/", {
    ...
    } else alert("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044E!");
}
async function getTasks() {
    try {
        const response = await (0, _axiosDefault.default).get(URL_ + "tasks" + "/");
...
function updateTask(e) {
    ...
    input.addEventListener("keydown", (e)=>{
        if (e.key === "Enter") saveTask(input, currentTaskName);
    });
}
async function deleteTask(e) {
    ...
    try {
        const response = await (0, _axiosDefault.default).delete(URL_ + "tasks" + "/" + `${undoneTasks[taskIndex].id}` + "/");
        getTasks();
    } catch (error) {
        console.error(error);
    }
...
async function switchTask(e) {
    ...
    if (task.classList.contains("red")) {
        let taskIndex = undoneTasks.map((e)=>e.text).indexOf(taskName);
        try {
            const response = await (0, _axiosDefault.default).patch(URL_ + "tasks" + "/" + `${undoneTasks[taskIndex].id}` + "/" + "mark_as_done" + "/");
            getTasks();
        } catch (error) {
            console.error(error);
        }
        ...
        try {
            const response = await (0, _axiosDefault.default).patch(URL_ + "tasks" + "/" + `${doneTasks[taskIndex].id}` + "/" + "mark_as_undone" + "/");
            getTasks();
        } catch (error) {
            console.error(error);
        }
...
async function clearTasks() {
    try {
        const response = await (0, _axiosDefault.default).delete(URL_ + "tasks" + "/" + "clear_tasks" + "/");
        getTasks();
    } catch (error) {
        console.error(error);
    }
...
async function allDoneTasks() {
    try {
        const response = await (0, _axiosDefault.default).patch(URL_ + "tasks" + "/" + "all_done_tasks" + "/");
        getTasks();
    } catch (error) {
        console.error(error);
    }
...
async function saveTask(input, oldTaskName) {
    ...
    if (newTaskName !== "") try {
        ...
        const response = await (0, _axiosDefault.default).patch(URL_ + "tasks" + "/" + `${undoneTasks[taskIndex].id}` + "/", {
            text: newTaskName
        });
        getTasks();
    } catch (error) {
...
function loadTasksFromFile(file) {
    ...
    reader.onload = async (e)=>{
        try {
            ...
            const response = await (0, _axiosDefault.default).post(URL_ + "tasks" + "/" + "replace_tasks" + "/", {
...
dropZone.addEventListener("drop", (e)=>{
    ...
    if (file && file.type === "application/json") loadTasksFromFile(file);
    else alert("\u041F\u043E\u0436\u0430\u043B\u0443\u0439\u0441\u0442\u0430, \u043F\u0435\u0440\u0435\u0442\u0430\u0449\u0438\u0442\u0435 \u043A\u043E\u0440\u0440\u0435\u043A\u0442\u043D\u044B\u0439 JSON \u0444\u0430\u0439\u043B.");
});
getTasks();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["86oZd","6rimH"], "6rimH", "parcelRequire5af9")
